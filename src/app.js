...
try {
    const { isEmpty, is8CharMin, containsSpecialsChar, containsNumbers } = require("./services/validations");
    ...
    checkButton.addEventListener("click", () => {
        ...
        feedbackMessageText = (isEmpty(gamerTagValue) && is8CharMin(gamerTagInput) && containsSpecialsChar(gamerTagInput) && containsNumbers(gamerTagInput))
